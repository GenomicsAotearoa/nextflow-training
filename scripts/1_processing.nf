...
process runSpadesAssembler {
    ...
    output:
        file("${sequence_id}.scaffolds.fasta")
        file("${sequence_id}.contigs.fasta")
        file("${sequence_id}.assembly_graph.fastg")
    ...
    mv output/scaffolds.fasta ./${sequence_id}.scaffolds.fasta
    mv output/contigs.fasta ./${sequence_id}.contigs.fasta
    mv output/assembly_graph.fastg ./${sequence_id}.assembly_graph.fastg
    """
}
